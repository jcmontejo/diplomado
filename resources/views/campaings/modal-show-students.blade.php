<div class="modal fade" id="modaladdStudentsShow" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Alumnos Agregados a Campaña</h5>
                ...
                <div class="col-lg-6 col-ml-12">
                    ...
                    <form id="form">
                        ...
                        <div class="table-responsive">
                            <table class="table" id="showStudents">
                                <thead>
                                    <th>Nombre</th>
