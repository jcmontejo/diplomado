                    ...
                    <form id="form">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control form-control-lg" id="nameBankSave"
                                    placeholder="">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="exampleInputPassword1">Número de Tarjeta*</label>
                                <input type="text" class="form-control form-control-lg" id="numberTargetBankSave"
                                    placeholder="">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="exampleInputPassword1">Clabe Interbancaria*</label>
                                <input type="text" class="form-control form-control-lg" id="keyBankSave"
                                    placeholder="">
                            </div>
                        </div>
                    </form>
