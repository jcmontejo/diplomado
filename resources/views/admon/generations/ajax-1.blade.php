...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            ...
            ajaxLoad('{{url('generaciones/alumnos/inscritos/'.$generation->id.'/')}}?search='+this.value)"
    ...
    <ul class="nav nav-tabs nav-fill">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#menu8">Pagos Administrativos</a>
        </li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>${{number_format($student->first_payment,2)}} <button data-toggle="modal"
                                    data-target="#modalEditarPrimerPago"
                                    onclick="modalEditarPrimerPago({{$student->debt_id}}, {{$student->total_debt}});"
                                    class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Modificar</button></td>
                            <td>
                                @if ($payment_1 AND $payment_1->status != 'PENDIENTE')
                                ${{number_format($payment_1->amount_paid,2)}}({{$payment_1->date}})<br><button
                                    data-toggle="modal" data-target="#modalEditarPago"
                                    onclick="editarPago({{$student->debt_id}}, {{$student->total_debt}}, 1);"
                                    class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Modificar</button>
                                @else
                                <div class="btn-group">
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button value="{{$student->id_inscription}}" OnClick="Discount(this);"
                                        class="btn btn-rounded btn-xs btn-warning mb-3" data-toggle="modal"
                                        data-target="#modalDiscount"><i class="fa fa-tag"></i>
                                        Descuento</button>
        ...
        <div class="tab-pane fade" id="menu8">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-2 bg-primary text-white text-center">DATOS DE PAGOS</div>
                   <table class="table">
                       <thead>
                           <tr>
                               <th>INSCRITOS</th>
