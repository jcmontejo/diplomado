...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            $('select[name="esquema_pago_docente"]').on('change', function() {
                var tipo = $(this).val();
                if (tipo == 1) {
                    $(".mostrar-estudiante").css("display", "block");
                    $(".mostrar-semana").css("display", "none");
                }
                if (tipo == 2) {
                    $(".mostrar-estudiante").css("display", "none");
                    $(".mostrar-semana").css("display", "block");
                }
            });
        });
        ...
        $("#saveGeneration").click(function() {
            ...
            //pagos a docentes
            var tipo_pago = $("#esquema_pago_docente").val();
            var pago_por_estudiante = $("#pago_por_estudiante").val();
            var pago_por_semana = $("#pago_por_semana").val();
            var total_semanas = $("#total_semanas").val();
                    ...
                    if (res.success == true) {
                        $.ajax({
                            ...
                            data: {
                                ...
                                //pago deocentes
                                tipo_pago: tipo_pago,
                                pago_por_estudiante: pago_por_estudiante,
                                pago_por_semana: pago_por_semana,
