...
@include('admon.generations.modal-show')
@include('admon.generations.modal-down')
@include('admon.generations.modal-details-low')
@include('admon.generations.modal-pay')
@include('admon.generations.modal-convenio')
@include('admon.generations.modal-editar-pago')
@endsection
@section('js')
<script>
