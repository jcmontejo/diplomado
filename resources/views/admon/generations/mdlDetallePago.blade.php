                ...
                <div id="block-editar_pago" style="display: none;">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control form-control-lg" id="psdMasterEditarPago"
                                placeholder="****************">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button type="button" class="btn btn-success btn-block" onclick="actualizarPago();"><i
                                    class="fas fa-check-square"></i>
                                ACTUALIZAR</button>
                            <button type="button" class="btn btn-secondary btn-block" onclick="cancelarEdicion();"><i
