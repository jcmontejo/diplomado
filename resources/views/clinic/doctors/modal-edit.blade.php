    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                    ...
                    <form id="form">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="lastname" placeholder="Introduce apellidos">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputPassword1">Teléfono de Contacto</label>
                                <input type="text" class="form-control form-control-lg" id="phone" placeholder="xxxxxxxxxx">
                            </div>
            ...
            <div class="modal-footer">
                ...
                <a href="#" id="updateDoctor" class="btn btn-primary mt-4 pr-4 pl-4" name="updateDoctor">Actualizar</a>
            </div>
        </div>
    </div>
</div>
