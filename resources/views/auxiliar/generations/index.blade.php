    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href="#" class="btn btn-rounded btn-primary mb-3 float-right" id="createGeneration"><i class="fas fa-plus"></i> Agregar
                    Nueva Generación</a>
...
@include('auxiliar.generations.modal-edit')
@include('auxiliar.generations.modal-create')
@include('auxiliar.generations.modal-students')
@endsection
@section('js')
<script>
    ...
    function checkPasswordTwo(){
        ...
        if (password==='Temporal.2019') {
            toastr.success('Contraseña correcta!', 'Bien hecho!')
            $('.actions_two input').attr('disabled', false);
            $("#password_two").val('');
        }else{
            $('.actions_two input').attr('disabled', 'disabled');
            toastr.error('Contraseña incorrecta!', 'Ooops!')
        }
    }
    ...
    function Charge() {
        $('#generations').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! url('/auxiliar/generaciones/datos') !!}',
