                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ${{number_format($payment_1->amount_paid,2)}}({{$payment_1->date}})<br><button  data-toggle="modal"
                                        data-target="#modalEditarPago" onclick="editarPago({{$student->debt_id}}, {{$student->total_debt}}, 1);" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Modificar</button>
                                        @else
                                        <div class="btn-group">
                                    ...
                                    <td>
                                        ...
                                        ${{number_format($payment_2->amount_paid,2)}}({{$payment_2->date}})<br><button  data-toggle="modal"
                                        data-target="#modalEditarPago" onclick="editarPago({{$student->debt_id}}, {{$student->total_debt}}, 2);" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Modificar</button>
                                        @else
                                        <div class="btn-group">
                                            <button @if ($student->total_debt == 0)
                                                disabled
                                    ...
                                    <td>
                                        ...
                                        ${{number_format($payment_3->amount_paid,2)}}({{$payment_3->date}})<br><button  data-toggle="modal"
                                        data-target="#modalEditarPago" onclick="editarPago({{$student->debt_id}}, {{$student->total_debt}}, 3);" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Modificar</button>
                                        @else
                                        <div class="btn-group">
                                            <button @if ($student->total_debt == 0)
                                                disabled
                                    ...
                                    <td>
                                        ...
                                        ${{number_format($payment_4->amount_paid,2)}}({{$payment_1->date}})<br><button  data-toggle="modal"
                                        data-target="#modalEditarPago" onclick="editarPago({{$student->debt_id}}, {{$student->total_debt}}, 4);" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Modificar</button>
                                        @else
                                        <div class="btn-group">
                                            <button @if ($student->total_debt == 0)
                                                disabled
                                    ...
                                    <td>
                                        ...
                                        ${{number_format($payment_5->amount_paid,2)}}({{$payment_1->date}})<br><button  data-toggle="modal"
                                        data-target="#modalEditarPago" onclick="editarPago({{$student->debt_id}}, {{$student->total_debt}}, 5);" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Modificar</button>
                                        @else
                                        <div class="btn-group">
                                            <button @if ($student->total_debt == 0)
                                                disabled
                                    ...
                                    <td>
                                        ...
                                        ${{number_format($payment_6->amount_paid,2)}}({{$payment_1->date}})<br><button  data-toggle="modal"
                                        data-target="#modalEditarPago" onclick="editarPago({{$student->debt_id}}, {{$student->total_debt}}, 6);" class="btn btn-xs btn-info"><i class="fas fa-edit"></i> Modificar</button>
                                        @else
                                        <div class="btn-group">
                                            <button @if ($student->total_debt == 0)
                                                disabled
